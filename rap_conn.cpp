...
conn::conn(void *conn_user_data, rap_conn_write_cb_t conn_write_cb, rap_conn_exch_init_cb_t conn_exch_init_cb)
    : conn_user_data_(conn_user_data), conn_write_cb_(conn_write_cb), frame_ptr_(frame_buf_), exchanges_(rap_max_exchange_id + 1)
{
  ...
  {
    exchanges_[id].init(static_cast<rap_conn *>(this), id, max_send_window, 0, 0);
